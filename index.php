...
<head>
    ...
    <style>
        body {
            background-color: <?php echo $theme === "dark" ? "grey" : "white"; ?>;
        }
        main{
          background-color: <?php echo $theme === "dark" ? "grey" : "white"; ?>;
        }
        main section:nth-child(even){          background-color: <?php echo $theme === "dark" ? "grey" : "white"; ?>;
}

    </style>
</head>
<body>
    <header class="container main-header" style="background-color: <?php echo $theme === "dark" ? "grey" : "white"; ?>;">
